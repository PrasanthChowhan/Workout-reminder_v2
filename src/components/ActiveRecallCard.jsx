    ...
    <section className="active-break-card recall-card" data-purpose="primary-session-card">
      <div className="recall-card-top">
        <div className="recall-card-header">
          ...
          <button className="recall-help-btn" title="Help / Tips">
            <svg className="help-icon" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
      ...
      <div className="recall-card-footer">
        {sessionCard?.source ? (
          ...
          >
            View Source
            <svg className="source-icon" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
        ...
        {!showAnswer ? (
          ...
          >
            Show Answer
            <svg className="btn-arrow-icon" fill="none" stroke="currentColor" strokeLinecap="round" strokeWidth="3" viewBox="0 0 24 24">
          ...
          >
            Done Session
            <svg className="btn-check-icon" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" viewBox="0 0 24 24">
